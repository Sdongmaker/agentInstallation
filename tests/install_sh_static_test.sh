...
assert_contains 'package_manager_busy_details'
assert_contains '修复选项'
assert_contains 'prompt_package_manager_kill_option'
assert_contains 'terminate_package_manager_processes'
assert_contains '终止占用进程'
assert_contains 'SIGTERM'
assert_contains 'SIGKILL'
